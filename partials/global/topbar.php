    ...
    <div class="w-full xl:pr-5 2xl:pr-[43px] flex items-stretch justify-between h-[60px] lg:h-[128px]">
        ...
        <div class="max-xl:pl-5 lg:pl-[28px]  xl:min-w-[180px] 2xl:min-w-[240px] flex  items-center xl:opacity-0">
            <a href="<?php echo get_home_url() ?>"> <img class="w-[43px] min-w-[43px] lg:w-[55px] "
                    src="<?php echo $theme_dir ?>/dist/Logo_128px_GrafikOnlinePL_v2.gif" alt="GrafikOnline logotyp"></a>
        </div>

        <div class="w-full text-[16px] dark:text-light text-lightmode_text flex items-center justify-center xl:hidden">
        ...
        <div
            class="border-[2px] dark:border-dark border-lightmode_ef w-[60px] lg:w-[110px] border-b-[0px] flex flex-none items-center justify-center xl:hidden">
        ...
        <!-- desktop -->
        <div
            class="desktop-menu on-scroll-initial hidden xl:flex items-center lg:w-6/12 xl:w-7/12 2xl:w-6/12 lg:pl-16 xl:pl-0 translate-y-0 transition-all">
            <ul class="w-full flex lg:gap-[8px] xl:gap-[38px] 2xl:gap-[68px] h-full items-center">

                <li class="relative fluid-text-base has-submenu group "><a href="<?php echo get_home_url() ?>"
                        class="cursor-pointer transition-all relative top-0 group-hover:-top-1 ">Studio</a>
                    <ul
                        class="submenu overflow-hidden transition-all absolute bottom-0  translate-y-[100%] hidden group-hover:flex group-hover:opacity-100 ">
                        <li class="child group/child"><a href="<?php echo get_home_url('', 'o-firmie') ?>">O
                                firmie <svg
                                    class="relative -left-3 opacity-0 transition-all group-hover/child:opacity-100 group-hover/child:left-0"
                                    xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-right"
                        ...
                        <li class="child group/child"><a href="<?php echo get_home_url('', 'kontakt') ?>">Kontakt <svg
                                    class="relative -left-3 opacity-0 transition-all group-hover/child:opacity-100 group-hover/child:left-0"
                                    xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-right"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="fluid-text-base group"><a class="transition-all relative top-0 group-hover:-top-1 "
                        href="<?php echo get_home_url('', 'projektowanie-logo') ?>">Projekt
                        Logo</a></li>
                <li class="fluid-text-base group"><a class="transition-all relative top-0 group-hover:-top-1 "
                        href="<?php echo get_home_url('', 'projekty-reklamowe') ?>">Projekty
                        Reklamowe</a></li>
                <li class="fluid-text-base group"><a class="transition-all relative top-0 group-hover:-top-1 "
                        href="<?php echo get_home_url('', 'strony-internetowe') ?>">Strony
                        Internetowe</a></li>
            </ul>
        </div>
        ...
        <div
            ...
            <!-- TODO: animacje svg -->
            <div class="cursor-pointer btn btn--dark btn--pricing__animation pricing__trigger group">
                <span>Cennik</span>
