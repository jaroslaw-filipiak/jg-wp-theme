...
<section id="contact-us-hero" class="dark:bg-gradient-to-r  lg:pl-0  lg:pr-14 lg:pt-[44px] ">
    ...
    <div class="flex aside-offset__margin ">
        <div class="w-full hidden lg:flex lg:w-5/12 xl:min-w-[586px]">
            <div class="w-full aspect-[1/1.111] bg-red rounded-lg xl:max-w-[586px]"></div>
        </div>
        <div class="w-full lg:w-7/12 lg:pl-[45px] xl:pl-[65px] 2xl:pl-[134px] pt-[38px] lg:pt-0 flex flex-col justify-between">
            <div class="flex items-center justify-between">
                <div class="flex flex-col items-start justify-between xl:pt-[16px]">
                    <h1 class="fluid-text-5xl max-w-[444px]">Czy <span class="text-red">jesteś gotowy
                        </span> na współpracę?
                    </h1>
                </div>
            </div>
            ...
            <div class="pb-[29px] pt-[38px] xl:pt-0 ">
                ...
                <div>
                    <div>
                        <p class="text-[14px] lg:fluid-text-base">Zadzwoń, wyślij wiadomość lub złóż zlecenie poprzez
                            <br />dedykowany do
                            tego
                    ...
                    <div class="lg:pt-[32px]">
                        <div class="flex flex-col xl:flex-row flex-wrap items-start xl:items-center lg:gap-[14px] 2xl:gap-[54px]">
                            <!-- TODO: icon -->
                            <a class="text-[14px] lg:fluid-text-base font-medium  max-lg:w-full max-lg:bg-dark max-lg:pt-[14px] max-lg:pb-[14px] max-lg:pl-6 max-lg:pr-6 max-lg:rounded-full whitespace-nowrap max-lg:order-2" href="#">
                                <img src="" style="width:11px;" alt="">
                                <p>+48 794 348 972</p>
                            </a>

                            <div class="text-[14px] max-lg:pt-[20px] max-lg:pb-[20px]  self-center lg:hidden max-lg:order-1">
                                PN
                                - PT
                                - 9:00 -
                                16:00
                            ...
                            <a class="text-[14px] lg:fluid-text-base font-medium  max-lg:w-full max-lg:bg-dark max-lg:pt-[14px] max-lg:pb-[14px] max-lg:pl-6 max-lg:pr-6 max-lg:rounded-full max-lg:order-3 max-lg:mt-[10px]" href="mailto:biuro@grafikonline.pl">
                                <img src="" style="width:11px;" alt="">
                                <p>biuro@grafikonline.pl</p>
                            </a>

                            <a href=" #" class="max-lg:order-4 btn btn--red whitespace-nowrap max-lg:w-full max-lg:mt-[10px]">
