...
<!-- after second swiper projects -->
<section class="pt-[28px] pb-12 service-grid-container lg:pb-[125px] aside-offset__margin">

    <h3 class="text-[20px] lg:fluid-text-3xl grid__title pt-[17px] xl:pt-0 pb-[24px] xl:pb-0">Potrzebujesz Projektu
        <br />
        Logo dla
        swojej
        działalności?
    ...
    <div class="flex items-end gap-[10px] lg:gap-[24px] mt-6 lg:mt-[50px] xl:mt-[56px] grid__buttons">
        ...
        <span class="hidden lg:flex"><a href="#" class="btn btn--dark group">
                <span>Cennik</span>
        ...
        <a href=" #" class="btn btn--red max-md:w-full">
            <span class="hidden lg:flex whitespace-nowrap">Zamów projekt</span>
    ...
    <p
        class="dark:dark:text-light text-lightmode_texttext-[14px] lg:text-[16px] border-b-[2px] dark:border-b-dark border-b-lightmode_ef pb-6 lg:pb-[50px] xl:max-w-[708px] grid__excerpt">
        Uporządkowana komunikacja wizualna marki pozwala skuteczniej ją
        prezentować i promować. Działamy według uporządkowanego schematu,
        dzięki któremu Twoja marka stanie się rozpoznawalna i zacznie budzić
        konkretne, oczekiwane skojarzenia u odbiorców.
    </p>
    ...
    <div class="  flex flex-col items-start justify-between grid__label xl:pb-[107px]">
        <div class="flex items-center gap-[24px]">
            ...
            <p class="text-[12px] lg:text-[14px] text-red uppercase font-medium ">Logo design</p>
        </div>
