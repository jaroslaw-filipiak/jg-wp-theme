...
/**
 * The template for displaying portfolio row after first swiper
 *
...
<section class="pt-[28px] pb-12 service-grid-container lg:pb-[125px] aside-offset__margin">
    ...
    <div class="flex items-end gap-[10px] lg:gap-[24px] mt-6 lg:mt-[50px] xl:mt-[56px] grid__buttons ">
        ...
        <span class="hidden lg:flex"><a href="#" class="btn btn--dark">
                <span>Cennik</span>
    ...
    <p class="text-light text-[14px] lg:text-[16px] border-b-[2px]  border-b-dark pb-6 lg:pb-[50px] xl:max-w-[708px] grid__excerpt">
        Uporządkowana
        komunikacja
        wizualna
        marki pozwala
        skuteczniej ją
        prezentować i promować. Działamy według
        uporządkowanego schematu, dzięki któremu Twoja marka stanie się rozpoznawalna i zacznie budzić konkretne,
        oczekiwane skojarzenia u odbiorców.</p>
