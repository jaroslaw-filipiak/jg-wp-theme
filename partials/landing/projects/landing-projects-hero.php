...
<section class="aside-offset__margin pt-[38px]  landing-hero lg:pt-[90px] max-w-full">
    ...
    <div class="mb-[20px] lg:mb-0 landing-hero__label flex items-end">
        <div class="flex items-center gap-[24px] h-[22px]">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-red lg:fill-gray" width="8" height="8" viewBox="0 0 8 8">
    ...
    <div class="landing-hero__subtitle">
        <p class="text-light text-[14px] lg:text-[16px] xl:max-w-[708px]">
    ...
    <!-- buttons -->
    <div class="flex flex-col md:flex-row items-center justify-center lg:justify-between  w-full 2xl:container mt-[24px] lg:mt-0  landing-hero__buttons">
