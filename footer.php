...
<footer class="footer">
	<div class="flex flex-col lg:flex-row items-start xl:items-stretch  aside-offset__margin ">
		<!-- 1 -->
		<div class="w-full xl:w-4/12  2xl:min-w-[460px] 2xl:max-w-[460px] lg:pr-10 xl:pr-12 xl:border-r-2 xl:border-dark">
			<h3 class="text-[18px] text-light mb-[36px] xl:mb-[93px] xl:text-[20px]">Dane firmowe</h3>
			<p class="text-dark2 xl:text-light text-[14px] mb-[26px] xl:mb-[36px] xl:text-[16px] leading-[28px]">
				Studio
				Graficzne
				Jarosław Grycaj <br class="hidden lg:block" /> ul. Księcia Witolda 49/15, Wrocław<br class="hidden lg:block" /> NIP:
				886
					...
					<div class="flex flex-col ">
						...
						<li class="group">
							<a class="lg:whitespace-nowrap flex flex-row-reverse lg:flex-row w-full justify-between lg:justify-start items-center gap-[22px]" href="#">
								...
								<!-- svg for mobile -->
								<svg class=" -rotate-90 w-[11px] lg:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.993 14.993">
									<path class="fill-light" id="Arrow_Down" d="M0,0V10.6H10.6V9.3H2.223L10.594.929,9.674.008,1.3,8.38V0Z" transform="translate(0 7.496) rotate(-45)"></path>
								</svg>
			...
			<div class="divider border-b-2 border-b-dark lg:hidden"></div>
		</div>
		<!-- 2 -->
		...
		<div class="w-full 2xl:w-full  xl:w-4/12 xl:pl-20 2xl:pl-[147px]">
			<h3 class="text-[18px] text-light mt-[24px] lg:mt-0 xl:text-[20px] xl:mb-[93px]">Zamów Projekt</h3>
			<p class="text-dark2 text-[14px] xl:text-[16px] xl:text-light mt-[36px]">Godziny pracy Studia <br />
				PN - PT - 9:00 - 16:00</p>
			...
			<div class="divider lg:hidden border-b-2 border-b-dark mt-[24px] mb-[14px]"></div>
...
<!-- back to top  -->
<div class="back-to-top w-[52px] xl:w-[80px] h-[52px] xl:h-[80px] bg-dark flex items-center justify-center rounded-full fixed bottom-6 rotate-180 right-6 cursor-pointer group hover:bg-red trnsition-all z-[9999]">
	...
	<!-- arrow desktop -->
	<svg class="relative hidden lg:flex top-0 group-hover:top-[4px] transition-all" xmlns=" http://www.w3.org/2000/svg" width="14.993" height="14.993" viewBox="0 0 14.993 14.993">
		<path id="Arrow_Down" d="M0,0V10.6H10.6V9.3H2.223L10.594.929,9.674.008,1.3,8.38V0Z" transform="translate(0 7.496) rotate(-45)" class="fill-light" />
	</svg>
