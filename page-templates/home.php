        ...
        <div class="testimonials swiper-wrapper">
            ...
            <div
                ...
                <div
                    ...
                    Jako firma Boxmet Ltd. Sp. z o.o. współpracujemy ze Studiem
                    GrafikOnline.PL od stosunkowo niedługiego czasu, jednak już
                    zdążyliśmy się przekonać o jakości obsługi i profesjonaliźmie.
                    Firma wykazała się kreatywnym i twórczym podejściem do
                    realizacji projektu nowego katalogu produktowego. Nasza
                    współpraca to nie tylko katalog, ale również stworzenie całej
                    szaty graficznej firmy, a w jej obrębie tworzenie wielu
                    projektów graficznych, takich jak banery na stronę www. Każdy
                    z projektów spotyka się z naszą aprobatą, pomimo wysoko
                    zawieszonych wymagań. To czyni współpracę łatwą i przyjemną,
                    ale przede wszystkim w efekcie wpływa na pozytywny wizerunek
                    firmy. Również projekty mniej typowe, spoza domyślnej oferty,
                    są obsługiwane przez Studio Graficznej Jarosław Grycaj z
                    pełnym zaangażowaniem. Zdecydowanie polecamy!
                </div>
